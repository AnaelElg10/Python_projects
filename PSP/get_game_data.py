...
def main(source, target):
    ...
    json_metadata_path = os.path.join(target_path, "metadata.json")
    make_json_metadata_file(json_metadata_path, new_game_dirs)
...
if __name__ == '__main__':
    args  = sys.argv
    if len(args) != 3:
        raise Exception("You must provide a source and destination path - only")
